...
// сортировка массива и вывод отсортированных слов на экран
        sortAndDisplay(poemArray);
    ...
    // метод для сортировки массива и вывода отсортированных слов на экран
    private void sortAndDisplay(String[] wordArray) {
        Arrays.sort(wordArray); // сортировка массива слов
        StringBuilder sortedText = new StringBuilder();
        for (String word : wordArray) {
            sortedText.append(word).append(" ");
        }

        output2.setText(sortedText.toString()); // вывод отсортированных слов на экран
    }
